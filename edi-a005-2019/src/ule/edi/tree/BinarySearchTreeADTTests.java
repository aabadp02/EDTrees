...
public class BinarySearchTreeADTTests {
	...
	*/
	...
	@Before
	public void setupBSTs() throws Exception {
		...
		TC3.insert(50, 20, 80, 10, 30, 70, 90, 80);
		...
		/*Collection<Integer> elements = null;
		elements.add(1);
		elements.add(2);
		elements.add(3);
		elements.add(4);
	...
	{	
		BinarySearchTreeADTImpl<String> TSV1 = null;
		
		TSV1 = new BinarySearchTreeADTImpl<String>();
		String element = null;

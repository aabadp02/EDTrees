...
public class BinarySearchTreeADTImpl<T extends Comparable<? super T>> extends
	...
	public void insert(Collection<T> elements) {
		...
		for(T t:elements) 
		{
			if(t == null)
			{
				throw new IllegalArgumentException("No se admiten elementos nulos");
			}
		}
	...
	public void insert(T ... elements) throws Exception {
		...
		for(int i = 0; i < elements.length; i++)
		{
			if(elements[i] == null)
			{
				throw new IllegalArgumentException("No puede haber elementos nulos");
			}
		}
	...
	public void insert(T element) {
		...
		if(this.content == null)
		{
			...
			BinarySearchTreeADTImpl<T> right = new BinarySearchTreeADTImpl<T>();
			BinarySearchTreeADTImpl<T> left = new BinarySearchTreeADTImpl<T>();
			
			this.setRightBST(right);
			this.setLeftBST(left);
		}
		else
		{
	 ...
	 */
	public void withdraw(Collection<T> elements) throws Exception {
	...
	public void withdraw(T element) {
		...
		if(this.content == null)
		{
			throw new NoSuchElementException("El elemento que intenta eliminar no existe");
		}
